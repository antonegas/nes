...
class CPU {
    ...
    private:
        ...
        /* 0X */ {&IMP, &BRK, 7}, {&IDX, &ORA, 6}, {&IMP, &JAM, 0}, {&IDX, &SLO, 8}, {&ZP0, &NOP, 3}, {&ZP0, &ORA, 3}, {&ZP0, &ASL, 5}, {&ZP0, &SLO, 5}, {&IMP, &PHP, 3}, {&IMM, &ORA, 2}, {&ACC, &ASL, 2}, {&IMM, &ANC, 2}, {&ABS, &NOP, 4}, {&ABS, &ORA, 4}, {&ABS, &ASL, 6}, {&ABS, &SLO, 6},
        /* 1X */ {&REL, &BPL, 2}, {&IDY, &ORA, 5}, {&IMP, &JAM, 0}, {&IDY, &SLO, 8}, {&ZPX, &NOP, 4}, {&ZPX, &ORA, 4}, {&ZPX, &ASL, 6}, {&ZPX, &SLO, 6}, {&IMP, &CLC, 2}, {&ABY, &ORA, 4}, {&ACC, &NOP, 2}, {&ABY, &SLO, 7}, {&ABX, &NOP, 4}, {&ABX, &ORA, 4}, {&ABX, &ASL, 7}, {&ABX, &SLO, 7},
        /* 2X */ {&ABS, &JSR, 6}, {&IDX, &AND, 6}, {&IMP, &JAM, 0}, {&IDX, &RLA, 8}, {&ZP0, &BIT, 3}, {&ZP0, &AND, 3}, {&ZP0, &ROL, 5}, {&ZP0, &RLA, 5}, {&IMP, &PLP, 4}, {&IMM, &AND, 2}, {&ACC, &ROL, 2}, {&IMM, &ANC, 2}, {&ABS, &BIT, 4}, {&ABS, &AND, 4}, {&ABS, &ROL, 6}, {&ABS, &RLA, 6},
        /* 3X */ {&REL, &BMI, 2}, {&IDY, &AND, 5}, {&IMP, &JAM, 0}, {&IDY, &RLA, 8}, {&ZPX, &NOP, 4}, {&ZPX, &AND, 4}, {&ZPX, &ROL, 6}, {&ZPX, &RLA, 6}, {&IMP, &SEC, 2}, {&ABY, &AND, 4}, {&ACC, &NOP, 2}, {&ABY, &RLA, 7}, {&ABX, &NOP, 4}, {&ABX, &AND, 4}, {&ABX, &ROL, 7}, {&ABX, &RLA, 7},
        /* 4X */ {&IMP, &RTI, 6}, {&IDX, &EOR, 6}, {&IMP, &JAM, 0}, {&IDX, &SRE, 8}, {&ZP0, &NOP, 3}, {&ZP0, &EOR, 3}, {&ZP0, &LSR, 5}, {&ZP0, &SRE, 5}, {&IMP, &PHA, 3}, {&IMM, &EOR, 2}, {&ACC, &LSR, 2}, {&IMM, &ALR, 2}, {&ABS, &JMP, 3}, {&ABS, &EOR, 4}, {&ABS, &LSR, 6}, {&ABS, &SRE, 6},
        /* 5X */ {&REL, &BVC, 2}, {&IDY, &EOR, 5}, {&IMP, &JAM, 0}, {&IDY, &SRE, 8}, {&ZPX, &NOP, 4}, {&ZPX, &EOR, 4}, {&ZPX, &LSR, 6}, {&ZPX, &SRE, 6}, {&IMP, &CLI, 2}, {&ABY, &EOR, 4}, {&ACC, &NOP, 2}, {&ABY, &SRE, 7}, {&ABX, &NOP, 4}, {&ABX, &EOR, 4}, {&ABX, &LSR, 7}, {&ABX, &SRE, 7},
        /* 6X */ {&IMP, &RTS, 6}, {&IDX, &ADC, 6}, {&IMP, &JAM, 0}, {&IDX, &RRA, 8}, {&ZP0, &NOP, 3}, {&ZP0, &ADC, 3}, {&ZP0, &ROR, 5}, {&ZP0, &RRA, 5}, {&IMP, &PLA, 4}, {&IMM, &ADC, 2}, {&ACC, &ROR, 2}, {&IMM, &ARR, 2}, {&IND, &JMP, 5}, {&ABS, &ADC, 4}, {&ABS, &ROR, 6}, {&ABS, &RRA, 6},
        /* 7X */ {&REL, &BVS, 2}, {&IDY, &ADC, 5}, {&IMP, &JAM, 0}, {&IDY, &RRA, 8}, {&ZPX, &NOP, 4}, {&ZPX, &ADC, 4}, {&ZPX, &ROR, 6}, {&ZPX, &RRA, 6}, {&IMP, &SEI, 2}, {&ABY, &ADC, 4}, {&ACC, &NOP, 2}, {&ABY, &RRA, 7}, {&ABX, &NOP, 4}, {&ABX, &ADC, 4}, {&ABX, &ROR, 7}, {&ABX, &RRA, 7},
        ...
        /* 9X */ {&REL, &BCC, 2}, {&IDY, &STA, 6}, {&IMP, &JAM, 0}, {&IDY, &AHX, 6}, {&ZPX, &STY, 4}, {&ZPX, &STA, 4}, {&ZPY, &STX, 4}, {&ZPY, &SAX, 4}, {&IMP, &TYA, 2}, {&ABY, &STA, 5}, {&IMP, &TXS, 2}, {&ABY, &TAS, 5}, {&ABX, &SHY, 5}, {&ABX, &STA, 5}, {&ABY, &SHX, 5}, {&ABY, &AHX, 5},
        ...
        /* BX */ {&REL, &BCS, 2}, {&IDY, &LDA, 5}, {&IMP, &JAM, 0}, {&IDY, &LAX, 5}, {&ZPX, &LDY, 4}, {&ZPX, &LDA, 4}, {&ZPY, &LDX, 4}, {&ZPY, &LAX, 4}, {&IMP, &CLV, 2}, {&ABY, &LDA, 4}, {&IMP, &TSX, 2}, {&ABY, &LAS, 4}, {&ABX, &LDY, 4}, {&ABX, &LDA, 4}, {&ABY, &LDX, 4}, {&ABY, &LAX, 4},
        ...
        /* DX */ {&REL, &BNE, 2}, {&IDY, &CMP, 5}, {&IMP, &JAM, 0}, {&IDY, &DCP, 8}, {&ZPX, &NOP, 4}, {&ZPX, &CMP, 4}, {&ZPX, &DEC, 6}, {&ZPX, &DCP, 6}, {&IMP, &CLD, 2}, {&ABY, &CMP, 4}, {&IMP, &NOP, 2}, {&ABY, &DCP, 7}, {&ABX, &NOP, 4}, {&ABX, &CMP, 4}, {&ABX, &DEC, 7}, {&ABX, &DCP, 7},
        ...
        /* FX */ {&REL, &BEQ, 2}, {&IDY, &SBC, 5}, {&IMP, &JAM, 0}, {&IDY, &ISC, 8}, {&ZPX, &NOP, 4}, {&ZPX, &SBC, 4}, {&ZPX, &INC, 6}, {&ZPX, &ISC, 6}, {&IMP, &SED, 2}, {&ABY, &SBC, 4}, {&IMP, &NOP, 2}, {&ABY, &ISC, 7}, {&ABX, &NOP, 4}, {&ABX, &SBC, 4}, {&ABX, &INC, 7}, {&ABX, &ISC, 7}
        };
};
